...
include 'validation/validate_update.php';
...
<form method = "post" action="update.php?playerID=<?php echo $playerID?>">
...
<!-- Name validation allows numbers too, as some names contain numbers apparently... 
...
<tr><td>
<input type="tel" name="phoneNumber" placeholder="Phone Number" required pattern="[0-9]{16}" value="<?php echo $phoneNumber;?>"></input>
